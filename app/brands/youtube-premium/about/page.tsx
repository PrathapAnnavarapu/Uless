...
export default function YouTubePremiumAboutPage() {
  const router = useRouter()
  const [brand, setBrand] = useState(null)
  const [isMounted, setIsMounted] = useState(false)
  const [imageError, setImageError] = useState(false)
  const slug = "youtube-premium"
  ...
  // Brand-specific content for YouTube Premium
  const additionalContent = {
    history:
      "YouTube Premium was launched in 2018 as a rebranding of YouTube Red, which was originally introduced in 2015. The service was created to offer an ad-free experience on YouTube along with exclusive content and features. YouTube Music Premium was also launched alongside YouTube Premium, offering an enhanced music streaming experience.",
    mission:
      "YouTube Premium's mission is to provide users with an enhanced, distraction-free viewing experience while supporting creators through subscription revenue rather than ad impressions. The service aims to offer additional features that improve how users interact with YouTube content.",
    impact:
      "YouTube Premium has transformed how people consume video content by removing ads and enabling background play and offline downloads. This has been particularly valuable for students who use YouTube for both entertainment and educational purposes. The service has also provided a new revenue stream for creators beyond traditional advertising.",
    studentProgram:
      "YouTube Premium Student offers all the benefits of YouTube Premium at a significantly reduced price. Students get a 1-month free trial followed by a discounted rate of $7.99/month (compared to the regular $11.99/month). The plan includes ad-free viewing, background play, downloads, and access to YouTube Music Premium. Students must verify their enrollment status through SheerID to qualify.",
  }
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="lg:col-span-2">
              ...
              <div className="p-6 rounded-xl bg-white shadow-sm">
                ...
                <div className="p-4 mb-6 rounded-lg bg-[#f8faff]">
                  <h3 className="mb-3 text-xl font-bold text-[#333]">Introducing our student plan</h3>
                  <p className="mb-4 text-[#666]">Enjoy YouTube and YouTube Music ad-free.</p>
                  <p className="font-medium text-[#5B48D9]">
                    1-month trial for US$0 • Then US$7.99⁠/⁠month • Cancel at any time
                  </p>
                </div>
                ...
                <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3">
                  <Button
                    ...
                    onClick={() => window.open("https://www.youtube.com/premium/student", "_blank")}
                  >
