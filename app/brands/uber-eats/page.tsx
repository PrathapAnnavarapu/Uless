...
export default function UberEatsPage() {
  ...
  const brand = mockBrands.find((b) => b.slug === "uber-eats") || {
    id: "uber-eats",
    name: "Uber Eats",
    slug: "uber-eats",
    logo: "/placeholder.svg?height=100&width=100&text=Uber%20Eats",
    category: "Food & Dining",
    discount: "$0 DELIVERY + 5% OFF",
    originalPrice: "Varies",
    studentPrice: "Varies + Discounts",
    description: "Uber Eats offers food delivery from thousands of restaurants with exclusive student discounts.",
    tagline: "Food delivery at your fingertips with student savings",
    benefits: [
          ...
          <div className="md:col-span-2">
            <div className="overflow-hidden bg-white rounded-2xl shadow-sm">
              ...
              <div className="relative w-full h-64 md:h-96">
                <Image
                  src="/placeholder.svg?height=400&width=800&text=Uber%20Eats%20Food%20Delivery"
                  alt={brand.name}
                  fill
              ...
              <div className="p-6 mb-6 bg-white rounded-2xl shadow-sm">
                ...
                {brand.parentCompany && (
                  <div className="mb-4">
                    ...
                    <div className="text-[#333]">{brand.parentCompany || "Uber Technologies, Inc."}</div>
                  </div>
                )}
                <div className="mb-4">
