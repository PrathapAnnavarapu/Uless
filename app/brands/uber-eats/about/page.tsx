...
export default function UberEatsAboutPage() {
  const router = useRouter()
  const [brand, setBrand] = useState(null)
  const [isMounted, setIsMounted] = useState(false)
  const [imageError, setImageError] = useState(false)
  const slug = "uber-eats"
  ...
  // Brand-specific content for Uber Eats
  const additionalContent = {
    history:
      "Uber Eats was launched in 2014 as UberFRESH in Santa Monica, California, as an extension of Uber's ride-sharing platform. The service was later rebranded as Uber Eats in 2015 and expanded globally. It has since grown to become one of the largest food delivery platforms worldwide, operating in over 6,000 cities across 45 countries.",
    mission:
      "Uber Eats aims to make eating well effortless for everyone, everywhere. The platform connects customers with their favorite local restaurants and delivers food directly to their doorstep, providing convenience and variety.",
    impact:
      "Uber Eats has transformed the food delivery industry by leveraging Uber's existing technology and driver network. The platform has helped thousands of local restaurants expand their customer base and increase revenue, especially during challenging times like the COVID-19 pandemic when in-person dining was restricted.",
    studentProgram:
      "Uber Eats offers a special student discount program that includes $0 delivery fees and 5% off all orders. Students can verify their status through their university email address to access these benefits. The program is designed to make food delivery more affordable for students, who often have tight budgets and busy schedules.",
  }
              ...
              <div className="p-6 rounded-xl bg-white shadow-sm">
                ...
                <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3">
                  <Button
                    ...
                    onClick={() => window.open("https://www.ubereats.com/student-hub", "_blank")}
                  >
