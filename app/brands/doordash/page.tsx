...
export default function DoorDashPage() {
  ...
  const brand = mockBrands.find((b) => b.slug === "doordash") || {
    id: "doordash",
    name: "DoorDash",
    slug: "doordash",
    logo: "/placeholder.svg?height=100&width=100&text=DoorDash",
    category: "Food & Dining",
    discount: "FREE DELIVERY + $5 OFF",
    originalPrice: "Varies",
    studentPrice: "Varies + Discounts",
    description: "DoorDash offers food delivery from thousands of restaurants with exclusive student discounts.",
          ...
          <div className="md:col-span-2">
            <div className="overflow-hidden bg-white rounded-2xl shadow-sm">
              ...
              <div className="relative w-full h-64 md:h-96">
                <Image
                  src="/placeholder.svg?height=400&width=800&text=DoorDash%20Food%20Delivery"
                  alt={brand.name}
                  fill
              ...
              <div className="p-6 mb-6 bg-white rounded-2xl shadow-sm">
                ...
                {brand.parentCompany && (
                  <div className="mb-4">
                    ...
                    <div className="text-[#333]">{brand.parentCompany || "DoorDash, Inc."}</div>
                  </div>
                )}
                <div className="mb-4">
