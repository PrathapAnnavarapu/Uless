...
export default function GrubhubPage() {
  ...
  const brand = mockBrands.find((b) => b.slug === "grubhub") || {
    id: "grubhub",
    name: "Grubhub",
    slug: "grubhub",
    logo: "/placeholder.svg?height=100&width=100&text=Grubhub",
    category: "Food & Dining",
    discount: "FREE DELIVERY + $10 OFF",
    originalPrice: "Varies",
    studentPrice: "Varies + Discounts",
    description: "Grubhub offers food delivery from thousands of restaurants with exclusive student discounts.",
          ...
          <div className="md:col-span-2">
            <div className="overflow-hidden bg-white rounded-2xl shadow-sm">
              ...
              <div className="relative w-full h-64 md:h-96">
                <Image
                  src="/placeholder.svg?height=400&width=800&text=Grubhub%20Food%20Delivery"
                  alt={brand.name}
                  fill
              ...
              <div className="p-6 mb-6 bg-white rounded-2xl shadow-sm">
                ...
                {brand.parentCompany && (
                  <div className="mb-4">
                    ...
                    <div className="text-[#333]">{brand.parentCompany || "Just Eat Takeaway"}</div>
                  </div>
                )}
                <div className="mb-4">
