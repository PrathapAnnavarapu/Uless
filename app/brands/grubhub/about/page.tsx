...
export default function GrubHubAboutPage() {
  ...
  // Brand-specific content for GrubHub
  const additionalContent = {
    history:
      "GrubHub was founded in 2004 by Matt Maloney and Mike Evans, who were both software developers at Apartments.com. The company began as a simple alternative to paper menus, allowing users to order food online from local restaurants. In 2013, GrubHub merged with Seamless, another food delivery service, expanding its reach. In 2020, Just Eat Takeaway.com acquired GrubHub for $7.3 billion.",
    mission:
      "GrubHub's mission is to connect hungry diners with the best local restaurants, making food ordering simple and enjoyable. The company aims to help diners discover new restaurants and dishes while providing restaurants with the tools they need to succeed in the digital age.",
    impact:
      "GrubHub has transformed how people order food by digitizing the takeout experience. The platform has helped thousands of local restaurants increase their revenue and reach new customers without having to build their own online ordering systems. During the COVID-19 pandemic, GrubHub became an essential service for many restaurants to stay in business.",
    studentProgram:
      "GrubHub offers students a free year of GrubHub+ membership, which normally costs $9.99/month. With GrubHub+ Student, students get unlimited free delivery on eligible orders, donation matching to student causes, and exclusive perks and deals from popular restaurants. To qualify, students must verify their status using their university email address.",
  }
              ...
              <div className="p-6 rounded-xl bg-white shadow-sm">
                ...
                <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3">
                  <Button
                    ...
                    onClick={() => window.open("https://www.grubhub.com/about/campus", "_blank")}
                  >
